...
Command: npx gltfjsx@6.2.5 public/models/ownscene.gltf -K -k
*/
...
export function Model(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/ownscene.gltf')
  const { actions } = useAnimations(animations, group)
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <group name="CharacterSpot" position={[-0.224, 0.22, -0.632]} rotation-x={11} rotation-y={6.4} rotation-z={2.5} rotation={[-Math.PI, 0.548, -Math.PI]}>
          <group name="Armature">
        ...
        <group name="keyboard" position={[0.017, 0.962, -1.297]} rotation={[0.001, -0.368, 0.018]} scale={0.755}>
        ...
        <mesh name="Comp_Mouse" geometry={nodes.Comp_Mouse.geometry} material={materials['lambert3SG.003']} position={[-0.212, 0.008, 0.051]} />
